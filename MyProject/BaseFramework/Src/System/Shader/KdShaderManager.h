...
public:
	...
	// 深度ステンシル
	ID3D11DepthStencilState* m_ds_ZEnable_ZWriteEnable = nullptr;	// する
	ID3D11DepthStencilState* m_ds_ZDisable_ZWriteDisable = nullptr;	// しない

	ID3D11DepthStencilState* m_ds_ZEnable_ZWriteDisable = nullptr;	// Z情報は使うけど登録はしない？
